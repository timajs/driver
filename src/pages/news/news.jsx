        ...
        <div className={css.news}>
            ...
            <div className={css.cards}>
                <div className={css.card}>
                   ...
                   <Link to="/newsInfo"><p className={css.text}>Сотрудники УОБДД по УВД области  предотвратили похищение девушки. Сотрудники УОБДД по УВД области предотвратили похищение девушки</p></Link>
                </div>
                <div className={css.card}>

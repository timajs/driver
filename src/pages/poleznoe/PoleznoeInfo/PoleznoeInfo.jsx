...
import css from './PoleznoeInfo.module.scss';
            ...
            <div className={css.useful__info}>
                ...
                <div className={css.container}>
                    <div className={css.left}>
                        <img className={css.road} src="/images/road.svg" alt="" />
                            ...
                            <div>
                                ...
                                <div className={css.comment}>
                                    <div className={css.author__container}>
                                        <img className={css.author} src="/images/author.svg" alt="" />
                            ...
                            <div>
                                ...
                                <div className={css.user__topic}>
                                    <div className={css.user__container}>
                                        <img className={css.user} src="/images/user.svg" alt="" />
                                        <p>name</p>
